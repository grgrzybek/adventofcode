...
public class Day09Test {
    ...
    public void test1() throws Exception {
        Deque<ST> states = new LinkedList<>();
        Deque<Integer> values = new LinkedList<>();
        states.push(ST.START);
        int idx = 0;
        int value = 1;
        int sum = 0;
        ...
        while (idx < tab.length) {
            if (tab[idx] == '!') {
                idx += 2;
            } else if (tab[idx] == '>' && states.peek() == ST.GARBAGE) {
                states.pop();
                idx++;
            } else if (tab[idx] == '<' && states.peek() != ST.GARBAGE) {
                states.push(ST.GARBAGE);
                idx++;
            } else if (tab[idx] == '{' && states.peek() != ST.GARBAGE) {
                states.push(ST.GROUP);
                sum += value++;
                idx++;
            } else if (tab[idx] == '}' && states.peek() == ST.GROUP) {
                value--;
                states.pop();
                idx++;
            } else {
